            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-up m-0">
                        <a href="/availgarage" class="dropdown-item">Available Garage</a>                        
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                        ...
                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-10 col-lg-7 text-center text-lg-start">
                                    <h6 class="text-white text-uppercase mb-3 animated slideInDown">Jl. Raya Bojongsoang Raya No.129, Bojongsoang, Kec. Bojongsoang, Kabupaten Bandung, Jawa Barat 40287</h6>
                                    <h1 class="display-3 text-white mb-4 pb-3 animated slideInDown">Bengkel Putra Dayak #129</h1>
                                    <a href="login.html" class="btn btn-primary py-3 px-5 animated slideInDown">Book Now<i class="fa fa-arrow-right ms-3"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="https://blog-media.lifepal.co.id/app/uploads/sites/3/2022/10/04124623/10-Daftar-Bengkel-Mobil-Yogyakarta-dan-Layanannya.jpg" alt="Image">
                    <div class="carousel-caption d-flex align-items-center">
                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-10 col-lg-7 text-center text-lg-start">
                                    <h6 class="text-white text-uppercase mb-3 animated slideInDown">Jalan Kenari No.83, Muja Muju, Kec. Umbulharjo, Kota Yogyakarta, Daerah Istimewa Yogyakarta</h6>
                                    <h1 class="display-3 text-white mb-4 pb-3 animated slideInDown">Bengkel Mobil Rajawali</h1>
                                    <a href="login.html" class="btn btn-primary py-3 px-5 animated slideInDown">Book Now<i class="fa fa-arrow-right ms-3"></i></a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="">Available Garage</a>
